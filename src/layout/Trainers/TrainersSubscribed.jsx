...
function TrainersSubscribed() {
  ...
  const [data, error, loading, reloadData] = useFetch(
    `/trainers/search-subscribed?name=${params.name}&exp=${params.experience}&planId=${params.subscriptionFilter}`
  );
      ...
      <div className="md:pl-3 px-3 text-white w-[100%] mb-16">
        <section className="section mt-1 mb-3">
          <div className="text-xl font-medium d-flex justify-between items-center">
            <h1>Subscribed Trainers List</h1>
        ...
        <div className=" w-[100%]">
          ...
          {data?.data && (
            <>
              ...
              <div className="row">
                <Card title="Total Subscribed Trainers" value={totalTrainers} />
                <Card
                  title="Organization Subscribed Trainers"
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    {dataSubscription?.data?.map((ele) => (
                      <option value={ele.id}>
                        {`₹${ele.price} for ${ele.duration} days`}
                      </option>
                    ))}
                  </select>
                </div>
                            ...
                            <tr key={item.id} className="Tbody">
                              ...
                              <td>
                                {item?.subscription?.subscriptionId ? (
                                  `₹${item?.subscription?.subscriptionId?.price} for ${item?.subscription?.subscriptionId?.duration} days`
                                ) : (
                                  <>
                                    "NA"
                                    <br />
...
export default TrainersSubscribed;
